...
export const CONTROL: BlockDef[] = [
  ...
  // shape:"stack" + no hasnext mutation is a documented cosmetic compromise (the frozen packager does
  // not model the cap-vs-stack distinction); options[] give fail-loud validation of the stop target.
  { signature: "stop [STOP_OPTION v]", opcode: "control_stop", shape: "stack",
    fields: { STOP_OPTION: { kind: "dropdown", options: ["all", "this script", "other scripts in sprite", "other scripts in stage"] } } },
